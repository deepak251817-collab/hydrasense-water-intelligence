...
export const mockWaterSources: WaterSource[] = [
  {
    id: "ARK-001",
    name: "Arkavathi Upstream Station",
    type: "River",
    location: "Nandi Hills Catchment",
    latitude: 13.3750,
    longitude: 77.6740,
    risk: "Stable",
    healthScore: 91,
    ...
    aiInsight: "Historical patterns suggest stable upstream conditions.",
    publicSuitability: {
      drinking: "Caution",
      domestic: "Safe",
      irrigation: "Safe",
  ...
  {
    id: "ARK-002",
    name: "Arkavathi Midstream Station",
    type: "River",
    location: "Doddaballapur Stretch",
    latitude: 13.2920,
    longitude: 77.5340,
    risk: "Watch",
    healthScore: 72,
    ...
    publicWarning: false,
    publicMessage: "Elevated turbidity and TDS detected. Conditions being monitored.",
    aiInsight: "Water-quality deterioration becomes more pronounced downstream.",
    publicSuitability: {
    ...
    historicalTrend: [
      ...
      { time: "18:00", pH: 7.0, turbidity: 9.7, tds: 348, dissolvedOxygen: 5.7, healthScore: 72 },
    ],
  },
  {
    id: "ARK-003",
    name: "Arkavathi Downstream Station",
    type: "River",
    location: "Thippagondanahalli Inflow",
    latitude: 12.9667,
    longitude: 77.3467,
    risk: "Critical",
    healthScore: 38,
    ...
    publicWarning: true,
    publicMessage: "A significant change in monitored water-quality parameters has been detected. The source is under investigation.",
    aiInsight: "Significant deterioration pattern detected across recent monitored parameters.",
    publicSuitability: {
      drinking: "Not Recommended",
      domestic: "Restricted",
    ...
    historicalTrend: [
      ...
      { time: "12:00", pH: 6.8, turbidity: 26.0, tds: 475, dissolvedOxygen: 4.3, healthScore: 38 },
      { time: "15:00", pH: 6.7, turbidity: 27.5, tds: 485, dissolvedOxygen: 4.2, healthScore: 38 },
      { time: "18:00", pH: 6.7, turbidity: 28.4, tds: 489, dissolvedOxygen: 4.1, healthScore: 38 },
    ],
  }
];
